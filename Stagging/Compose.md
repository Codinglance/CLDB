{
  ...
  "questions": [
    ...
    },
    {
      ...
      "expectedReadTime": "1 min",
      "markdown": "Jetpack Compose is Android’s modern UI toolkit that lets developers build UI using Kotlin instead of XML, making development faster and simpler.\n\n##### \uD83D\uDE80 Less Code\nRemoves XML layouts and reduces boilerplate code.\n\n##### ⚡ Faster Development\nDeclarative UI with live previews speeds up development.\n\n##### \uD83C\uDFA8 Easy Theming\nBuilt-in Material Design and better dark mode support.\n\n##### \uD83E\uDDE9 Reusable UI\nComposable functions improve modularity and maintainability.\n\n##### \uD83D\uDD04 Better State Management\nUI updates automatically when data changes.\n\n##### \uD83D\uDCF1 Improved Performance\nSmart recomposition updates only necessary UI parts.\n\n##### \uD83D\uDD17 Interoperability\nWorks with existing XML-based Views for gradual migration.\n\n#### ✅ Conclusion\nCompose simplifies Android UI development with cleaner code, better performance, and faster UI creation.\n"
    },
    {
      "id": 6,
      "section": "Jetpack Compose Basics",
